        ...
        <section id='About' className='mt-[8rem] m-8'>
            <div>
                ...
                <div className='pt-5 md:pt-0'>
                    ...
                    <div className='circle absolute xl:top-[65rem] xl:left-[40.5rem] top-[78.5rem] left-[4.7rem] w-60 h-60 bg-w animate-spin  bg-gradient-to-r from-second to-[#05AE8C] rounded-full -z-10'></div>
                </div>
