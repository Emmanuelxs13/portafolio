...
const Header = () => {
   ...
   // Estilos de los botones
    const Button = "inline-block rounded-full border-2 border-none px-6 pb-[6px] pt-2 text-xs font-medium uppercase leading-normal text-accent-700 transition duration-150 ease-in-out hover:border-primary-accent-100 hover:bg-neutral-500 hover:bg-opacity-10 focus:border-primary-accent-100 focus:outline-none focus:ring-0 active:border-primary-accent-200 dark:text-accent-100 dark:hover:bg-gray-400 dark:hover:bg-opacity-10";
  ...
  <header className="flex items-center justify-between xl:justify-start w-full py-4 px-8 h-[10vh] z-50 sticky top-0 bg-white animate-fade-down animate-once animate-ease-in-out">
    <div className="xl:w-1/6 text-center -mt-4">
        <a href="#" className="text-2xl font-bold relative p-1 bg-white">
          ...
          <RiCheckboxBlankCircleFill className="absolute -left-3 -bottom-3 text-accent -z-10" />
        </a>
    </div>
