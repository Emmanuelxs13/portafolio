      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
        ...
        <div className='flex flex-col gap-3'>
          <a href='https://github.com/Emmanuelxs13/Proyectos/tree/master/Apps/doodle_jump' target={'_blank'}>
            <img src="./DoodleJump.png" className='w-full rounded-3xl mb-4 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110'/>
          </a>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-[8rem]'>
          <div className='flex flex-col gap-4'>
            ...
            <img src="./StackGame.png" className='w-full rounded-3xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 object-cover'/>
            </a>
        ...
        <div className='flex flex-col gap-4'>
          <a href='https://github.com/Emmanuelxs13/Proyectos/tree/master/Apps/dashboard-store' target={'_blank'}>
            <img src="./Store.png" className='w-full rounded-3xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 object-cover'/>
          </a>
        ...
        <div className='flex flex-col gap-4'>
          <a className='https://github.com/Emmanuelxs13/Proyectos/tree/master/Apps/DinnoGame' target={'_blank'}>
            <img src="./DinnoGame.png" className='w-full rounded-3xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 object-cover'/>
          </a>
        ...
        <div className='flex flex-col gap-4'>
          <a href='https://github.com/Emmanuelxs13/Proyectos/tree/master/Apps/ESH-Biometria' target={'_blank'}>
            <img src="./ESH.png" className='w-full rounded-3xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 object-cover'/>
          </a>
